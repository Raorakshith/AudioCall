...
public class WorkerThread extends Thread {
    ...
    public final void joinChannel(final String channel, int uid) {
        ...
        ensureRtcEngineReadyLock();
        mRtcEngine.joinChannel("0063d641fd85ced4d1fa2bee08f1e66cd21IAA1HTMtV6JAHdnqboFVg5GdwZcd4SriifRTA/KHjGDBZZGDPfMAAAAAEACqPfBqKhDjYAEAAQAqEONg", channel, "OpenVCall", uid);
